          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-16">
            <div className="lg:col-span-2">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-3xl font-bold">Professional AC Services</h2>
              </div>

              <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 mb-8">
                <p className="text-gray-700 mb-6 text-lg leading-relaxed">
                  At Bilal Technical Services, we provide top-quality AC repair and installation services for
                  residential and commercial properties throughout Dubai. Our team of experienced professionals is
                  committed to delivering exceptional results that exceed your expectations.
                </p>
                <p className="text-gray-700 mb-8 text-lg leading-relaxed">
                  Whether you need AC installation, repair, or maintenance for your home, office, or commercial space,
                  we have the expertise and equipment to handle projects of any size. We service all brands and models
              ...
              <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 sticky top-24">
                ...
                <ul className="space-y-4 mb-8">
                  <li className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-blue-600 mr-3 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">Experienced and skilled professionals</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-blue-600 mr-3 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">Premium quality materials and equipment</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-blue-600 mr-3 mt-0.5 flex-shrink-0" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 text-center relative">
              ...
              <div className="pt-4">
                ...
                <p className="text-gray-600">We discuss your requirements and provide expert advice.</p>
              </div>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 text-center relative">
              <div className="absolute -top-5 left-1/2 transform -translate-x-1/2">
              ...
              <div className="pt-4">
                ...
                <p className="text-gray-600">We provide a detailed and transparent quote for your approval.</p>
              </div>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 text-center relative">
              <div className="absolute -top-5 left-1/2 transform -translate-x-1/2">
        ...
        <section className="mb-24 relative overflow-hidden rounded-2xl">
          ...
          <div className="relative z-10 px-8 py-16 text-center">
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto text-blue-100">
              Contact us today for a free consultation and quote on your AC service needs
            </p>
