          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-16">
            <div className="lg:col-span-2">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-3xl font-bold">Professional Gypsum Work</h2>
              </div>

              <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 mb-8">
                <p className="text-gray-700 mb-6 text-lg leading-relaxed">
                  At Bilal Technical Services, we provide top-quality gypsum work for residential and commercial
                  properties throughout Dubai. Our team of skilled professionals specializes in creating beautiful
                  ceilings, partitions, and decorative elements that transform your spaces.
                </p>
                <p className="text-gray-700 mb-8 text-lg leading-relaxed">
                  Whether you need a simple false ceiling, elaborate decorative designs, partition walls, or repairs to
                  existing gypsum work, we have the expertise and tools to handle projects of any size. We combine
                  technical skill with artistic design to create stunning results that enhance your interior spaces.
                </p>
              ...
              <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 mb-8">
                <h3 className="text-xl font-bold mb-6">Types of Gypsum Ceiling Designs</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-3">
                    <h4 className="font-semibold text-lg">Simple False Ceiling</h4>
                    <p className="text-gray-600">
                      Clean, minimalist designs that add elegance to any room while concealing wiring and fixtures.
                    </p>
                  </div>
                  <div className="space-y-3">
                    <h4 className="font-semibold text-lg">Multi-level Ceilings</h4>
                    <p className="text-gray-600">
                      Layered designs that create depth and visual interest, often with integrated lighting.
                    </p>
                  </div>
                  <div className="space-y-3">
                    <h4 className="font-semibold text-lg">Coffered Ceilings</h4>
                    <p className="text-gray-600">
                      Grid-like patterns that add architectural interest and a classic, sophisticated look.
                    </p>
                  </div>
                  <div className="space-y-3">
                    <h4 className="font-semibold text-lg">Decorative Ceilings</h4>
                    <p className="text-gray-600">
                      Artistic designs with curves, patterns, and decorative elements for a luxurious feel.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 sticky top-24">
                ...
                <ul className="space-y-4 mb-8">
                  <li className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-blue-600 mr-3 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">Experienced and skilled gypsum specialists</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-blue-600 mr-3 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">Quality materials and tools</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-blue-600 mr-3 mt-0.5 flex-shrink-0" />
        ...
        <section className="mb-24">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              We follow a streamlined process to ensure high-quality results and customer satisfaction
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 text-center relative">
              ...
              <div className="pt-4">
                ...
                <p className="text-gray-600">We discuss your requirements and provide design options.</p>
              </div>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 text-center relative">
              <div className="absolute -top-5 left-1/2 transform -translate-x-1/2">
              ...
              <div className="pt-4">
                <h3 className="text-xl font-bold mb-3">Design & Quotation</h3>
                <p className="text-gray-600">We create a design plan and provide a detailed quote.</p>
              </div>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 text-center relative">
              <div className="absolute -top-5 left-1/2 transform -translate-x-1/2">
              ...
              <div className="pt-4">
                ...
                <p className="text-gray-600">Our skilled team completes the work with precision and care.</p>
              </div>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 text-center relative">
              <div className="absolute -top-5 left-1/2 transform -translate-x-1/2">
              ...
              <div className="pt-4">
                ...
                <p className="text-gray-600">We ensure everything meets our high quality standards.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mb-24 relative overflow-hidden rounded-2xl">
          ...
          <div className="relative z-10 px-8 py-16 text-center">
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto text-blue-100">
              Contact us today for a free consultation and quote on your gypsum ceiling and partition needs
            </p>
