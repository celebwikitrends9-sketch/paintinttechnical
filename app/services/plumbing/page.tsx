          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-16">
            <div className="lg:col-span-2">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-3xl font-bold">Professional Plumbing Services</h2>
              </div>

              <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 mb-8">
                <p className="text-gray-700 mb-6 text-lg leading-relaxed">
                  At Bilal Technical Services, we provide top-quality plumbing services for residential and commercial
                  properties throughout Dubai. Our team of experienced plumbers is committed to delivering efficient
                  solutions for all your plumbing needs.
                </p>
                <p className="text-gray-700 mb-8 text-lg leading-relaxed">
                  Whether you're dealing with a leaky faucet, clogged drain, need new fixture installations, or facing a
                  plumbing emergency, we have the expertise and equipment to handle projects of any size. We use quality
                  materials and follow industry best practices to ensure lasting results.
                </p>
              ...
              <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 sticky top-24">
                ...
                <ul className="space-y-4 mb-8">
                  <li className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-blue-600 mr-3 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">Experienced and skilled plumbers</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-blue-600 mr-3 mt-0.5 flex-shrink-0" />
        ...
        <section className="mb-24 relative overflow-hidden rounded-2xl">
          ...
          <div className="relative z-10 px-8 py-16 text-center">
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto text-blue-100">
              Contact us today for a free consultation and quote on your plumbing needs
            </p>
