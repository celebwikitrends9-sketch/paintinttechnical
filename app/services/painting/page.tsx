          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-16">
            <div className="lg:col-span-2">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-3xl font-bold">Professional {service.title}</h2>
              </div>
              ...
              <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 mb-8">
                ...
                <p className="text-gray-700 mb-8 text-lg leading-relaxed">
                  Whether you need painting services for your home, office, or commercial space, we have the expertise
                  and equipment to handle projects of any size. We use only premium quality materials and follow
                  industry best practices to ensure lasting results.
                </p>
        ...
        <section className="mb-24 relative overflow-hidden rounded-2xl">
          ...
          <div className="relative z-10 px-8 py-16 text-center">
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto text-blue-100">
              Contact us today for a free consultation and quote on your painting needs
            </p>
